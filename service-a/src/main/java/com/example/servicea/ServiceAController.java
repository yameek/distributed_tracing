...
public class ServiceAController {
    ...
    @Observed(name = "service-a.send-async-notification")
    ...
    @Observed(name = "service-a.process-callback")
    ...
    @Observed(name = "service-a.update-order-status")
    ...
    @Observed(name = "service-a.verify-order")
